...
It is the ability to solve complex problems<br> or make decisions. 

It has then evolved in lifeforms to adapt to diverse environments for their survival and reproduction. <!-- .element class="fragment"-->
...
But machines cannot reproduce themselves... 

Does it mean that they are not intelligent? <!-- .element class="fragment"-->
