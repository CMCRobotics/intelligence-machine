...
# if mode == "train":
    ...
    # Save model to file
    model.save('../models/detect_emotions_norm.keras') #new way of saving - not only the weights

# emotions will be displayed on your face from the webcam feed
elif mode == "display":

    model = tf.keras.models.load_model("../models/detect_emotions_norm.keras")
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            cropped_img = cv2.resize(roi_gray, (48, 48))  # resize to 48×48
            cropped_img = (cropped_img.astype("float32") / 127.5) -1  # normalize like training
